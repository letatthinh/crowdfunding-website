var About = {
    ...
    loadSmartContract: async function () {
        ...
        About.smartContract = TruffleContract(smartContractJSON)
        console.log('[TASK] Processed data from the smart contract JSON file...')
        About.smartContract.setProvider(Ethereum.ethereumProvider)
    ...
    loadAboutPage: function() {
        Page.loadNavigationBar(Enums.page.about)
        Page.loadPageFooter()
